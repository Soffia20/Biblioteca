...
<head>
    ...
    <!-- TIPOGRAFIA/Custom fonts for this template-->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- NAVBAR BARRA IZQUIERDA/ Sidebar -->
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- NOTIFICACIONES Nav Item - Alerts -->
                        ...
                        <!-- USUARIO Nav Item - User Information -->
                        ...
                        <li class="nav-item">
                            ...
                            href="index.php?c=InicioSesion&a=cerrar">
