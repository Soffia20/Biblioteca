        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                    ...
                    <form class="formulario" action="index.php?c=Prestamos&a=guardar" method="POST" id="insertarPres" name="insertarPres" autocomplete="off">
                        <label for="estudiante">Estudiante</label>
                        <input type="text" id="estudiante" name="estudiante_nombre" placeholder="Escribe el nombre del estudiante" required minlength="10" maxlength="50" multipleSpaces="true" autocomplete="off" />
                        <input type="hidden" id="estudiante_id" name="estudiante"/>
                        <ul id="sugerencias" class="lista-sugerencias"></ul>

                        <label for="fecha_ent">Fecha de Entrega</label>
                        <input type="date" id="fecha_ent" name="fecha_ent" required min="<?php echo date('Y-m-d'); ?>" />
                    
                        <label for="fecha_dev">Fecha de devolución</label>
                        <select id="fecha_dev" name="fecha_dev" required >
                        ...
                        <div class="contenedor-botones">
                            ...
                            <a href="index.php?c=Prestamos&a=index" class="botonRegresar">Regresar</a>
                        </div>
                    </form>
                <!-- /.container-fluid -->
