...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                    ...
                    <form class="formulario" action="index.php?c=Historial&a=actualizar" method="POST" id="modificarHis" name="modificarHis" autocomplete="off">
                        ...
                        <select id="prestamo" name="prestamo" required>
                            ...
                            <?php foreach ($data["prestamos"] as $prestamo): ?>
                                <option value="<?php echo $prestamo['Id_prestamo']; ?>"
                                    <?php if ($data["historial_prestamos"]["Prestamo"] == $prestamo['Id_prestamo']) echo "selected"; ?>>
                        ...
                        <input type="text" id="descripcion" name="descripcion" required minlength="10" maxlength="200" multipleSpaces="true" letters="true" value="<?php echo $data["historial_prestamos"]["Descripcion"]?>" />

                        <label for="fecha">Fecha</label>
                        <input type="date" id="fecha" name="fecha" required readonly value="<?php echo $data["historial_prestamos"]["Fecha"]?>" />
                
                        <label for="estado">Estado</label>
                        <select id="estado" name="estado" required>
                            <option value="Activo" <?php if($data["historial_prestamos"]["Estado"] == "Activo") echo "selected"; ?>>Activo</option>
                            <option value="Resuelto" <?php if($data["historial_prestamos"]["Estado"] == "Resuelto") echo "selected"; ?>>Resuelto</option>
                        </select>

                        <div class="contenedor-botones">
                            <button class="boton" id="actualizar" name="actualizar" type="submit">Actualizar</button>
                            <a href="index.php?c=Historial&a=index" class="botonRegresar">Regresar</a>
                        </div>
                    </form>
    ...
    <script src="Validaciones/Historial_Insertar.js"></script>
