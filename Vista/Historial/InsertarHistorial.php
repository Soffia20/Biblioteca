        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                    ...
                    <form class="formulario" action="index.php?c=Historial&a=guardar" method="POST" id="insertarHis" name="insertarHis" autocomplete="off">
                        ...
                        <input type="text" id="descripcion" name="descripcion" required minlength="10" maxlength="200" multipleSpaces="true" letters="true"/>
