    ...
    <style>
        ...
        /* Botón Guardar */
            .boton {
                ...
                height: 50px;
                box-shadow: inset 0 4px 6px rgba(0, 198, 201, 0.6);        
            }
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                    ...
                    <form class="formulario" action="index.php?c=estudiantes&a=guardar" method="POST" id="insertarEst" name="insertarEst" autocomplete="off" >
                        <label for="matricula">Matrícula</label>
                        <input type="text" id="matricula" name="matricula" required minlength="8" maxlength="20" numeros="true" noSpaces="true" integer="true"/>

                        <label for="nombre">Nombre</label>
                        <input type="text" id="nombre" name="nombre" required minlength="10" maxlength="50" letters="true"/>

                        <label for="fecha">Grado</label>
                        <input type="text" id="grado" name="grado" required minlength="1" maxlength="2" numeros="true" integer="true" noSpaces="true"/>

                        <label for="seccion">Sección</label>
                        <input type="text" id="seccion" name="seccion" required minlength="1" maxlength="2" letters="true" noSpaces="true"/>
                        ...
                        <input type="text" id="contacto" name="contacto" required minlength="10" maxlength="50" alphanumeric="true" noSpaces="true"/>
                        ...
                        <div class="controls" style="display: none;">
                            <button class="boton" type="button" onclick="clearImage()">Eliminar</button>
                        </div>
    ...
    <script src="Validaciones/Estudiantes_Insertar.js"></script>
</body>
</html>