...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                    ...
                    <form class="formulario" action="index.php?c=carreras&a=actualizar" method="POST" id="modificarCarr" name="modificarCarr" autocomplete="off">
                        <input type="hidden" id="id" name="id" value="<?php echo $data["id"]; ?>" />
                        <label for="nombre">Nombre</label>
                        <input type="text" id="nombre" name="nombre" required minlength="10" maxlength="200" multipleSpaces="true" letters="true" value="<?php echo $data["carreras"]["Nombre"]?>"/>

                        <div class="contenedor-botones">
                            <button class="boton" id="guardar" name="guardar" type="submit">Actualizar</button>
    ...
    <script src="Validaciones/Carrera_Modificar.js"></script>
</body>
</html>