...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                    ...
                    <form class="formulario" action="index.php?c=detalle_prestamo&a=guardar" method="POST" id="insertarDet" name="insertarDet" autocomplete="off">
                        ...
                        <input type="text" id="libro_nombre" placeholder="Escribe el título del libro" required minlength="3" maxlength="200"/>
    ...
    <script src="Validaciones/Detalle_prestamo_Insertar.js"></script>
