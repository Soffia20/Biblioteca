...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- End of Topbar -->
                    ...
                    <form class="formulario" action="index.php?c=detalle_prestamo&a=actualizar" method="POST" id="modificarDet" name="modificarDet" autocomplete="off">
                        <input type="hidden" id="id" name="id" value="<?php echo $data["id"]; ?>" />
                        
                        <label for="prestamo">Préstamo</label>
                        <select id="prestamo" name="prestamo" required>
                            <option value="" disabled>Selecciona un préstamo</option>
                            <?php foreach ($data["prestamos"] as $prestamo): ?>
                                <option value="<?php echo $prestamo['Id_prestamo']; ?>"
                                    <?php if ($data["detalle_prestamo"]["Prestamo"] == $prestamo['Id_prestamo']) echo "selected"; ?>>
                                    <?php echo $prestamo['Id_prestamo'] . " - " . $prestamo['estudiante'] . " - " . $prestamo['Fecha_prestamo']; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>

                        <label for="libro_nombre">Libro</label>
                        <input type="text" id="libro_nombre" placeholder="Escribe el título del libro" value="<?php echo $data["detalle_prestamo"]["Libro"]; ?>" required minlength="3" maxlength="200"/>
                        <input type="hidden" id="libro" name="libro" value="<?php echo $data["detalle_prestamo"]["Libro"]; ?>" />
                        <ul id="sugerencias" class="lista-sugerencias"></ul>
                
                        <!-- <label for="cantidad">Cantidad</label>
                        <input type="text" id="cantidad" name="cantidad" required minlength="1" maxlength="1" value="<?php echo $data["detalle_prestamo"]["Cantidad"]?>"/> -->

                        <label for="cantidad">Cantidad</label>
                        <!-- <input type="text" id="cantidad" name="cantidad" required minlength="1" maxlength="1"/> -->
                        <input type="number" id="cantidad" name="cantidad" min="1" max="10" value="<?php echo $data["detalle_prestamo"]["Cantidad"]?>">
                        <script>
                            document.getElementById('cantidad').addEventListener('input', function(e) {
                                const max = parseInt(this.max);
                                if (parseInt(this.value) > max) {
                                alert('Has excedido la cantidad disponible');
                                this.value = max;
                                }
                            });
                        </script>
                        ...
                        <div class="contenedor-botones">
                            ...
                            <a href="index.php?c=detalle_prestamo&a=index" class="botonRegresar">Regresar</a>
                        </div>
                    </form>
    ...
    <script src="Validaciones/Detalle_prestamo_Modificar.js"></script>
</body>
</html>